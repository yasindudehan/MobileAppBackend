...
module.exports = function validateOrder(data){
    ...
    data.salesrepName = !isEmpty(data.salesrepName) ? data.salesrepName : "";
    data.customerName = !isEmpty(data.customerName) ? data.area : "";
    ...
    if (Validator.isEmpty(data.Invoiceno)) {
        errors.Invoiceno = "Invoiceno field is required";
    }
    if (Validator.isEmpty(data.salesrepName)) {
        errors.salesrepName = "sales name field is required";
    }
    ...
    if (Validator.isEmpty(data.orderDate)) {
        errors.orderDate = "Item  field is required";
    }
    return {
        errors,
