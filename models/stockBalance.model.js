...
const StockBalanceSchema = new Schema(
  {
    ...
    teabag1: {
      ...
      weight: { type: String,  default: "25pack" },
      qut: { type: Number, default: 0 },
      price: { type: Number, required: true, default: 0 },
...
StockBalanceSchema.plugin(AutoIncrement, {
  inc_field: "stockblanceno ",
  unique: true
});
module.exports = mongoose.model("StockBalnace", StockBalanceSchema);
